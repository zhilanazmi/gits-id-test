...
<div class="flex flex-wrap items-center justify-between gap-2 mb-6">
    <h6 class="font-semibold mb-0 dark:text-white">Authors</h6>
    <ul class="flex items-center gap-[6px]">
        ...
        <li>-</li>
        <li class="font-medium">Authors</li>
    </ul>
</div>

<div class="card border-0 shadow-none">
    <div class="card-header flex items-center justify-between flex-wrap gap-3">
        <h5 class="text-lg font-semibold mb-0">Authors List</h5>
        <div class="flex items-center gap-3 flex-wrap">
            <form action="{{ route('authors.index') }}" method="GET" class="flex items-center gap-2">
                <input type="text" name="search" value="{{ request('search') }}" placeholder="Search authors..." class="form-control form-control-sm rounded-lg">
                <button type="submit" class="btn btn-primary-600 btn-sm">
                    <iconify-icon icon="ion:search-outline"></iconify-icon>
                </button>
            </form>
            <a href="{{ route('authors.create') }}" class="btn btn-primary-600 btn-sm flex items-center gap-1">
        ...
        <div class="overflow-x-auto">
            <table class="table bordered-table mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="flex items-center gap-2">
                                <a href="{{ route('authors.edit', $author['id']) }}" class="w-8 h-8 bg-success-100 dark:bg-success-600/25 text-success-600 dark:text-success-400 rounded-full inline-flex items-center justify-center" title="Edit">
                    ...
                    @empty
                    <tr>
                        <td colspan="5" class="text-center text-secondary-light">No authors found</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
